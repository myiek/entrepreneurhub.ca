 ...
 */
?>
		<?php $count = 0; //the number of posts 
		global $curauth;
		if (have_posts()) : while (have_posts()) : the_post(); ?>
			<?php
				//figure out whether we have a normal or an image post
				if ($count == 5) break; // number of posts to show
			...
			?>
			<div id="post-<?php the_ID(); ?>" <?php post_class('images-only'); ?>>
		...
		<?php endwhile; else: ?>
			...
			<div class="post-inners"> 
			<div class="post-title"> 
				<a class="superlink" href="" title="No Posts Yet!." rel="bookmark"></a> 
				<a class="supertitle" href="" title="No Posts Yet." rel="bookmark">No Posts Yet!</a> 
				<p>by <a class="author" href="" title=""><?php echo $curauth->display_name; ?></a> | 01-01-1111</p> 
				<a href="" title="No Posts Yet!"><img src=<?php echo get_template_directory_uri(); ?>/images/go.png" alt="post-arrow" /></a>  <!-- arrow for navigation --> 
			</div> 
				<div class="post-content">
					<p><strong><?php echo $curauth->display_name; ?> hasn't written any posts yet!</strong></p>
					<p>Visit again soon! Please <a href="<?php echo home_url(); ?>/" title="<?php bloginfo('description'); ?>">return to the home page</a> or use the search form below.</p>
			...
			<?php 
			$older = get_next_posts_link('<div class="older"><p>&laquo; More</p></div><!--.older-->');   // encloses the entire div in a link
			$newer = get_previous_posts_link('<div class="newer"><p>Back &raquo;</p></div><!--.older-->'); // encloses the entire div in a link
			if(!$newer)
				$older = get_next_posts_link('<div class="older big"><p>&laquo; More</p></div><!--.older-->');
			if(!$older)
				$newer = get_previous_posts_link('<div class="newer big"><p>Back &raquo;</p></div><!--.older-->');
